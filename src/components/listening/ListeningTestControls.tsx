...
import { 
  Maximize, Minimize, ZoomIn, ZoomOut, Clock, 
  AlertTriangle
} from 'lucide-react';
import {
  Select,
...
interface ListeningTestControlsProps {
  fontSize: number;
...
export function ListeningTestControls({
  fontSize,
  setFontSize,
  isFullscreen,
  toggleFullscreen,
  ...
  const decreaseFontSize = () => {
    if (fontSize > 6) setFontSize(fontSize - 2);
  };
