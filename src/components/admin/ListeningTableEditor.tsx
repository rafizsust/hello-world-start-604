...
interface ListeningTableEditorProps {
  value: TableEditorData | TableData;
...
// Helper to normalize input value to TableEditorData
function normalizeValue(value: TableEditorData | TableData): TableEditorData {
...
export function ListeningTableEditor({ value, onChange, startQuestionNumber, endQuestionNumber }: ListeningTableEditorProps) {
  const [editorData, setEditorData] = useState<TableEditorData>(() => normalizeValue(value));
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2">
              <Input
                ...
                placeholder="Enter table heading (e.g., 'Types of Bee Species')"
              />
            </div>
            <div>
              <Select
