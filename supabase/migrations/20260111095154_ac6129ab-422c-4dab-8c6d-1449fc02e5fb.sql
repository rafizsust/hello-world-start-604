-- Update check_and_reserve_credits to skip limit for admins
CREATE OR REPLACE FUNCTION public.check_and_reserve_credits(p_user_id uuid, p_cost integer)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
-- Update get_credit_status to show unlimited for admins
